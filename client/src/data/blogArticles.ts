...
<p>يظل التبييض المهني الطريقة الأكثر أمانًا وفعالية. استشر الدكتورة فردوس مستين لأفضل خيار يناسب احتياجاتك.</p>`,
    },
    en: {
...
<p>Au cabinet du Dr. Firdaous MOUSTAINE, nous évaluons votre cas pour recommander la meilleure solution adaptée à vos besoins.</p>`,
    ...
    ar: {
      ...
      excerpt: 'دليل شامل لمساعدتك في الاختيار بين زراعة الأسنان والجسر. المزايا والعيوب والتكاليف والمتانة لكل خيار تشرحها الدكتورة مستين.',
...
<p>في عيادة الدكتورة فردوس مستين، نقيّم حالتك للتوصية بأفضل حل يناسب احتياجاتك.</p>`,
    },
    en: {
...
<p>في عيادة الدكتورة فردوس مستين، نخلق بيئة مطمئنة للأطفال. نهجنا اللطيف يحول كل زيارة إلى مغامرة إيجابية.</p>`,
    },
    en: {
...
<p>هذه القواعد تضمن فمًا صحيًا. استشر الدكتورة فردوس مستين للمتابعة الشخصية.</p>`,
    },
    en: {
...
<p>لم يفت الأوان للحصول على الابتسامة التي تستحقها. في عيادة الدكتورة فردوس مستين، نرافقك بخبرة.</p>`,
    },
    en: {
